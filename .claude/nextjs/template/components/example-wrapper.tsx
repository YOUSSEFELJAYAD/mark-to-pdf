...
/**
 * ExampleWrapper - Container for showcasing multiple examples in a grid layout
 * Use this as the outer wrapper when displaying multiple component examples
 */
 ...
 * Wraps a single component example with consistent styling and optional label
 */
function Example({
  title,
  children,
